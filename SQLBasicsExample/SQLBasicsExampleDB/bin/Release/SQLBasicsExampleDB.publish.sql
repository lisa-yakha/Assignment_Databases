...
GO
PRINT N'Creating Foreign Key [dbo].[FK_ProductReference]...';


GO
ALTER TABLE [dbo].[Inventory]
    ADD CONSTRAINT [FK_ProductReference] FOREIGN KEY ([ProductReference]) REFERENCES [dbo].[Products] ([Id]);


GO
PRINT N'Creating Procedure [dbo].[DELETE_Product_by_Title]...';
...
GO
PRINT N'Creating Procedure [dbo].[INSERT_Inventory]...';
...
GO
PRINT N'Creating Procedure [dbo].[INSERT_Product]...';
...
GO
PRINT N'Creating Procedure [dbo].[RETRIEVE_AllProducts]...';
...
GO
PRINT N'Creating Procedure [dbo].[RETRIEVE_ProductsByName]...';
...
GO
PRINT N'Creating Procedure [dbo].[RETRIEVE_TitleForProduct]...';
...
GO
PRINT N'Creating Procedure [dbo].[UPDATE_ProductTitle]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'ed969e6f-960e-42ec-954e-febf727a9be2')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('ed969e6f-960e-42ec-954e-febf727a9be2')
